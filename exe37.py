...
system('cls')
print(f'\nCódigo do mais magro: {cod_clientes[cod_magro]}')
print(f'Código do mais pesado: {cod_clientes[cod_gordo]}')
print(f'Código do mais alto: {cod_clientes[cod_alto]}')
print(f'Código do mais baixo: {cod_clientes[cod_baixo]}')
print(f'Média de altura: {sum(altura_clientes) / len(altura_clientes):.2f}')
print(f'Média de peso: {sum(peso_clientes) / len(peso_clientes):.2f}')
